...
/**
 * Test class for class {@link EFontResourceKurintoMono}.
 *
 * @author Philip Helger
 */
public final class EFontResourceKurintoMonoTest
{
  @Test
  public void testBasic ()
  {
    final ICommonsSet <String> aUniquePaths = new CommonsHashSet <> ();
    for (final EFontResourceKurintoMono e : EFontResourceKurintoMono.values ())
    {
