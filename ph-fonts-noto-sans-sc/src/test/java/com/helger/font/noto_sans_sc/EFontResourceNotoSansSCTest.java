...
/**
 * Test class for class {@link EFontResourceNotoSansSC}.
 *
 * @author Philip Helger
 */
public final class EFontResourceNotoSansSCTest
{
  @Test
  public void testBasic ()
  {
    final ICommonsSet <String> aUniquePaths = new CommonsHashSet <> ();
    for (final EFontResourceNotoSansSC e : EFontResourceNotoSansSC.values ())
    {
