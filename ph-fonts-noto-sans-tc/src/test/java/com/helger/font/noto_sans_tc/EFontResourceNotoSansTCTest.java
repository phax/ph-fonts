...
/**
 * Test class for class {@link EFontResourceNotoSansTC}.
 *
 * @author Philip Helger
 */
public final class EFontResourceNotoSansTCTest
{
  @Test
  public void testBasic ()
  {
    final ICommonsSet <String> aUniquePaths = new CommonsHashSet <> ();
    for (final EFontResourceNotoSansTC e : EFontResourceNotoSansTC.values ())
    {
