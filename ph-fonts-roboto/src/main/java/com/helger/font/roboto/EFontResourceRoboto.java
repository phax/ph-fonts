...
public enum EFontResourceRoboto implements IHasFontResource
{
  ...
  ROBOTO_CONDENSED_LIGHT ("Roboto Condensed",
                          EFontType.TTF,
                          EFontStyle.REGULAR,
                          EFontWeight.LIGHT,
                          "fonts/ttf/Roboto/RobotoCondensed-Light.ttf"),
  ROBOTO_CONDENSED_LIGHT_ITALIC ("Roboto Condensed",
                                 EFontType.TTF,
                                 EFontStyle.ITALIC,
                                 EFontWeight.LIGHT,
                                 "fonts/ttf/Roboto/RobotoCondensed-LightItalic.ttf"),
  ROBOTO_CONDENSED_NORMAL ("Roboto Condensed",
                           EFontType.TTF,
                           EFontStyle.REGULAR,
                           EFontWeight.REGULAR,
                           "fonts/ttf/Roboto/RobotoCondensed-Regular.ttf"),
  ROBOTO_CONDENSED_NORMAL_ITALIC ("Roboto Condensed",
                                  EFontType.TTF,
                                  EFontStyle.ITALIC,
                                  EFontWeight.REGULAR,
                                  "fonts/ttf/Roboto/RobotoCondensed-Italic.ttf"),
  ROBOTO_CONDENSED_BOLD ("Roboto Condensed",
                         EFontType.TTF,
                         EFontStyle.REGULAR,
                         EFontWeight.BOLD,
                         "fonts/ttf/Roboto/RobotoCondensed-Bold.ttf"),
  ROBOTO_CONDENSED_BOLD_ITALIC ("Roboto Condensed",
                                EFontType.TTF,
                                EFontStyle.ITALIC,
                                EFontWeight.BOLD,
                                "fonts/ttf/Roboto/RobotoCondensed-BoldItalic.ttf");

  private final FontResource m_aRes;

  EFontResourceRoboto (@Nonnull @Nonempty final String sFontName,
